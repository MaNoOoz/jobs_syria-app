...
class AddJobScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AddJobFormController controller = Get.put(AddJobFormController());
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'إضافة وظيفة جديدة',
          style: GoogleFonts.tajawal(fontWeight: FontWeight.bold, color: cs.onPrimaryContainer),
        ),
        centerTitle: true,
        backgroundColor: cs.primaryContainer, // Changed for consistency
      ),
      body: Padding(
            ...
            children: [
              ...
              Obx(
                  ...
                  children: controller.contactOptions.map((opt) {
                    return Chip(
                      label: Text('${opt.type.displayName}: ${opt.value}'),
              ...
              Obx(
                  ...
                  label: Text(controller.isLoading.value ? 'جاري الحفظ...' : 'حفظ الوظيفة'),
                  style: ElevatedButton.styleFrom(
